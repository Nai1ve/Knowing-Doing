...
@media (max-width: 580px) { .assessment-actions, .assessment-navigation, .assessment-submission, .dimension-list article > div { align-items: stretch; flex-direction: column; }.assessment-actions button { width: 100%; justify-content: center; }.scale-options { gap: 4px; }.scale-options span { display: none; } }
</style>

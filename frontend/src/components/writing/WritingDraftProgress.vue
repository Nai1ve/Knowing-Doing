...
const phases = [
  { key: 'indexing', label: '整理实践记录', detail: '归并 SQL、结果、判断与参考来源' },
  { key: 'outlining', label: '组织文章结构', detail: '提炼问题、证据和解决路径' },
  { key: 'drafting', label: '生成文章初稿', detail: '将本次实践写成可编辑内容' },
  { key: 'checking', label: '检查引用边界', detail: '核对每个段落的实验和来源依据' },
]

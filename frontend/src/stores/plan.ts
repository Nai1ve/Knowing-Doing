...
export const usePlanStore = defineStore('plan', () => {
  ...
  function syncLegacyPlan(source: ProductPlan) {
    ...
    plan.value = {
      id: source.id, title: source.title, technology: source.templateKey === 'mysql-performance-v1' ? 'MySQL 8' : '待实施内容', goal: source.goal,
      ...
      completedUnits, totalUnits: source.units.length, weeklyMinutes: source.weeklyMinutes ?? 240,
